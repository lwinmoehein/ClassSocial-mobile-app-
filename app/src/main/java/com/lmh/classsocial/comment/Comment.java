package com.lmh.classsocial.comment;
...
import com.lmh.classsocial.UIAdapters.CommentAdapter;
...
public class Comment extends AppCompatActivity {
    ...
    List<com.lmh.classsocial.Model.Comment> comments;
                    ...
                    if (!s.equals("err")) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                com.lmh.classsocial.Model.Comment comment = new com.lmh.classsocial.Model.Comment(id, postid, accid, accname, commentbody, date);
