...
import com.lmh.classsocial.Message.ActiveListFragment;
...
public class MessageFragment extends Fragment {
    ...
    private void setUpViewPager(ViewPager viewPager) {
        MessageViewPagerAdapter adapter = new MessageViewPagerAdapter(getActivity().getSupportFragmentManager());
